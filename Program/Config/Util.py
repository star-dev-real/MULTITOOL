...
try:
    ...
    print(f'Modules of the python library required for Axiom are not installed, make sure you have correctly installed python and have launched the "Setup.py" file which will install all the necessary modules.')
    input(f'Error: {e}')

color_webhook = 0xa80505
username_webhook = name_tool
avatar_webhook = 'https://cdn.discordapp.com/attachments/1337898355279401023/1341890893858213908/Axiom-Logo.png?ex=67b7a4c8&is=67b65348&hm=174ddbd80dd8570fa83779687def6eda441a7c12abd3765d970c1958ceeb1ec8&'
...
def Reset():
    if os_name == "Windows":
        file = ['python', os.path.join(tool_path, "Axiom.py")]
        subprocess.run(file)

    elif os_name == "Linux":
        file = ['python3', os.path.join(tool_path, "Axiom.py")]
        subprocess.run(file)
